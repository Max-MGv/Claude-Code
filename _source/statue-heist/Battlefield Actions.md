# Battlefield Actions
* Battlefield Actions start at the end of the monsters turn - with a big tell
* they resolve at the start of enemies next turn - Unless players stop it or mitigate
* Party has to figure out what the effect is - and how to prevent it
	* If the players figure out the mechanich they can stop the action or minimize its impact
	* if they cant - battlefield action takes players - but they know next time how to prevent it
...
## Summoning / Chanting
*  Boss Summoning Minions
	* 3 circles appear on the battlefield and energy coalesces - forming into arcane mosnters/elementals
	* Mechanic: if player stands on the circle - summoning cannot take palce

## Area of Effect Attacks
* simply mark where they are attacking next


## Energy Beam/Sphere Attack
* Attack whoever attacked last (area of effect)
	* Boss starts summoning arcane energy that grows every second - Redirects it at whoever attacks it
	* Mechanic: Redirection - not stoppage


## Line of Sight attack
* whoever is in line of sight gets attacked/petrified/fear/sleep/
	* As the boss looks at you - you feel this overwhelming energy


## Concentrating On a Deadly Spell
* Mage needs 1 action to cast a ginormours fireball or tsunami - you need to break their concentration

## Barrier Shield
* Boss starts putting up barriers doing god knows what behind it - maybe they are casting a spell with concentration

## Mirror Image
* Boss creates copies of themself and they cast the spell as many times as there are copies
...
**Optional Damage Rule:** If you wish for Battlefield Actions to be less punishing for your players if they don’t manage to mitigate them, you can choose the monster’s action that deals the highest damage out of all of that monster’s actions, and deal the same damage with that monster’s battlefield actions.
...
## Saving Throw Formula : **8 + key ability modifier + Proficiency Bonus**
